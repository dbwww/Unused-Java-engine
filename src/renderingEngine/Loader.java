...
public class Loader {
	...
	public RawModelData loadToVAO(float[] vertices, int[] indices, float[] uv) {
		...
		return new RawModelData(vaoID, indices.length);
	...
	public int loadTexture(String fileName) {
		...
		try {
			texture = TextureLoader.getTexture("PNG", new FileInputStream(new File("resources/textures/" + fileName + ".png")));
