...
public abstract class ShaderMaster {
    ...
    public ShaderMaster(String vertexFile, String fragmentFile) {
    ...
    protected int getUniformLoc(String varName) {
    ...
    private int loadShader(String file, int type) {
         ...
         InputStream in = ShaderMaster.class.getResourceAsStream(file);
         ...
         try {
             ...
             e.printStackTrace();
             System.err.println("Can't load shader!");
             System.exit(-1);
         }
